...
<head>
    <title>吃掉神農</title>
    <meta itemprop="name" content="吃掉神農" />
    <meta itemprop="description" content="FD能新概念音游" />
    <meta charset="utf-8" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">FD能新概念音游</div><br />
                ...
                <div id="btn_group" style="display: block;">
                    <a class="btn btn-primary btn-lg" onclick="readyBtn()">開始遊戲</a>
                    <br/><br/>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="mode">
                            ...
                            <li><a class="dropdown-item" onclick="changeMode(MODE_ENDLESS)">無盡模式</a></li>
                            <li><a class="dropdown-item" onclick="changeMode(MODE_PRACTICE)">練習模式</a></li>
                        </ul>
                    </div>
